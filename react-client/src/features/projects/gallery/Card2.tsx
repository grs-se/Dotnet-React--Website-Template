...
export default function Card2({ project }: Props) {
	return (

		<div className="m-6 bg-white border border-gray-200 rounded shadow dark:bg-gray-800 dark:border-gray-700">
			<a href="#">
				<img className="rounded-t object-cover" src={project.pictureUrl} alt="" />
			</a>
			<div className="p-5">
				<a href="#">
